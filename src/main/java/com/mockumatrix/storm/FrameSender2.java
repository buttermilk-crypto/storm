 ...
 *
 */
public class FrameSender2 implements Runnable {
	...
	public FrameSender2(Display display, StormFrame frame, AccountManager accountManager, PropertiesManager propsManager, Text outputText) {
		super();
	...
	public void sendAsPartial() {
		...
		long id = frame.entries.get(0).tweetId;
